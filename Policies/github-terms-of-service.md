...
<sup><sup><sub><sub><sub>🔱</sub></sub></sub></sup></sup>&nbsp;Please&nbsp;note&nbsp;that if&nbsp;the&nbsp;trident&nbsp;symbol is&nbsp;not being&nbsp;rendered for&nbsp;you, this&nbsp;subsection may&nbsp;not be&nbsp;helpful for&nbsp;discovering all&nbsp;such&nbsp;obligations. Also&nbsp;note&nbsp;that whilst&nbsp;the&nbsp;text&nbsp;':<i>collapsible</i>:' never&nbsp;begins with&nbsp;a&nbsp;trident, in&nbsp;the&nbsp;absence of&nbsp;an&nbsp;indication that&nbsp;you&nbsp;don't need&nbsp;to&nbsp;examine a&nbsp;particular&nbsp;collapsible&nbsp;text, you&nbsp;do need&nbsp;to&nbsp;expand such&nbsp;collapsible&nbsp;text to&nbsp;check whether&nbsp;there&nbsp;exists one or more &nbsp'tridented'&nbsp;texts within&nbsp;the&nbsp;collapsible&nbsp;block. 
<BR><BR>
<TABLE>
 <TR>

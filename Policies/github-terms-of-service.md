...
- Non-self-consenting accounts become self-consenting automatically once they satisfy the conditions for self-consent above. If self-consenting account loses legal ability to consent by itself, account is suspended until user either becomes self-consenting again or is consented by his/her/its legal guardian.
...
- In case user is not a self-consenting one, consenter will be held responsible for keeping secure the accounts that he/she/it consented to.
...
You retain ownership of and responsibility for Content you create. 
...
Paid accounts may have [private repositories](/articles/making-a-public-repository-private/), which allow the User to control access to Content. GitHub employees [only access private repositories when access is required for security or maintenance](/articles/github-security/#employee-access) or for support reasons, and then only with the consent of the repository owner. Non-self consenting users' repositories will only be accessed with consenter's consent. Because we respect your privacy in private repositories, you must respect the Terms of Service in everything you post to a private repository. If we have reason to believe the contents of a private repository are in violation of the law or of these Terms, we have the right to remove them.
...
GitHub cannot be held responsible for misparenting. GitHub is not intended as a toy even if you use as such.

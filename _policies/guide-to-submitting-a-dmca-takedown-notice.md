...
- Code may be alleged to infringe, not because it is a direct copy, but because it is used to [circumvent access controls](http://copyright.gov/title17/92chap12.html).
